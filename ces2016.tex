...
\vspace{-11mm}
\begin{IEEEbiographynophoto}{Peter A. Zientara}
...
\end{IEEEbiographynophoto}
\vspace{-12mm}
\begin{IEEEbiographynophoto}{Nikhil Shukla}
...
\end{IEEEbiographynophoto}
\vspace{-12mm}
\begin{IEEEbiographynophoto}{Ikenna Okafor}
...
\end{IEEEbiographynophoto}
\vspace{-12mm}
\begin{IEEEbiographynophoto}{Kevin Irick}
...
Doctoral degree in computer science and engineering from the Pennsylvania State University in 2009. Kevin held a research appointment in the 
Microsystems Design Lab in the Department of Computer Science and Engineering at Penn State. As a research associate, Irick participated in several industry and 
federal funded research projects with particular focus on hardware acceleration of vision algorithms. His research activities included 
application-specific hardware accelerator design methodology, hardware-assisted image processing and recognition, 
...
\end{IEEEbiographynophoto}
\vspace{-12mm}
\begin{IEEEbiographynophoto}{Suman Datta}
...
Corporation. He was instrumental in the demonstration
of III-V quantum-well transistors operating at
room temperature with a record energy delay product,
the first experimental demonstration of high-performance
high-k/metal gate CMOS transistors, and the invention and
demonstration of nonplanar trigate transistors. He is currently a Professor
of Electrical Engineering at the University of Notre Dame and is the holder of more than 160 U.S. patents.
His group is exploring new materials and novel device architecture for
CMOS enhancement and replacement for future energy-efficient computing
applications. Dr. Datta is a Distinguished Lecturer of the IEEE Electron
Devices Society and a Fellow member of IEEE.
\end{IEEEbiographynophoto}
