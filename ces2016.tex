...
\thanks{Authors are with the School of Electrical Engineering and Computer Science, Pennsylvania State University, PA, USA (email: \{paz117, ska130, sampson, vijay\}@cse.psu.edu)}% <-this % stops a space
...
received the B.E. degree in Computer Engineering from the York University in 2011 and is currently pursuing his Ph.D. in Computer Science and Engineering from the the Pennsylvania State University. His research interests are in smart sensors and embedded vision systems.
