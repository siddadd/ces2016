...
similar RoIs. Figure~\ref{tab:saliencyc} illustrates this flow where AIM is used to generate initial seed RoIs that are then coupled with 
...
that, if the previous classification is an apple, then the next region
is more likely a bannanna than a strawberry, and this probability can
